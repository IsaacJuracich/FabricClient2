...
public class NahrFont {
        ...
        try {
            if ((font instanceof Font))
                ...
                if (((String)font).toLowerCase().endsWith("ttf") || ((String)font).toLowerCase().endsWith("otf"))
                    this.theFont = Font.createFont(0, new File(Palace.getInstance().getPalaceDirectory() + File.separator + "fonts", (String)font)).deriveFont(size);
                else
                ...
                if (name.toLowerCase().endsWith("ttf") || name.endsWith("otf"))
                    this.theFont = Font.createFont(0, new File(Palace.getInstance().getPalaceDirectory() + File.separator + "fonts", name)).deriveFont(size);
                else
    ...
    private final void drawer(MatrixStack matrixStack, String text, float x, float y, int color) {
        ...
        y *= 2.0F;
        DrawUtils.setup2DRender(false);
        DrawUtils.bindTexture(this.resourceLocation);
        ...
        DrawUtils.shaderColor(0xffffffff);
    }
